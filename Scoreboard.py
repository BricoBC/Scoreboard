...
import views_two as v_2

window = tk.Tk()
window.title("Scoreboard")
window.geometry("650x500") #anchoXaltura

lblQuestion = tk.Label(window, text="¿Cuántos registros va a tener la tabla en total?")
...
boton_mostrar = tk.Button(window, text="Ok", command=lambda: v_2.hide_window_inicial(window))
